...
describe('Infrastracture', () => {
    ...
    test('[失敗][GENRE]fetch blog which does not exists', async() => {
        ...
        expect(await res[0]['error']['S']).toEqual('一致するデータが見つかりませんでした')
    })
    /*
