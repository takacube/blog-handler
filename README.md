...
```bash
blog-tracking-app$ sam logs -n HelloWorldFunction --stack-name blog-tracking-app --tail
```
...
```bash
aws cloudformation delete-stack --stack-name blog-tracking-app
```
